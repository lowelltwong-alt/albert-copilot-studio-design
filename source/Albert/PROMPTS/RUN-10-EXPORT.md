...
Required inputs: human acceptance of exact manual_reviewed_candidate or actual hash-verified assembly, current SCRIPT/CLAIMS/KC10/T06/STATE/decision, intended internal audience

Saved output suffixes: W09-SPEAKERS.txt, W09-SPOKEN.txt, W09-TIMING.md, copy of permitted KC10/CLAIMS
...
Export only the exact human-accepted revision. Copy approved speech unchanged. Keep HOST_A/HOST_B labels in SPEAKERS; remove labels/citations/cues from SPOKEN; put pause positions, pronunciation notes and chapter navigation in TIMING. Do not generate audio or submit to a vendor. Report spoken words and pause seconds separately, using actual external count if supplied; otherwise label model_count_estimate and require operator verification. Estimate words/rate + pause_seconds/60 at 145 words/min central and 130–160 sensitivity; this is a planning range, not measured audio. Reopen/compare exact export to reviewed script; a paraphrase is a new unreviewed draft. Hold on stale or absent human acceptance. Never send author-only notes to an audio producer.

## Included P09

Source: [reference/process-0.3/P09-review-join-stop.md](../More/MVP-Reference/reference/process-0.3/P09-review-join-stop.md). Byte source SHA-256: `d7aa81ea6a02cdb85e23682f4bac822b6c257dde960dc208f30d005645d7132e`.
