...
|---|---|---|
| Albert Case Analyst | `roles/ROLE-ANALYST.md` | Extract a bounded case profile from the supplied source. |
| Albert Writer | `roles/ROLE-WRITER.md` | Draft the requested artifact from the accepted packet. |
| Albert Evidence Reviewer | `roles/ROLE-EVIDENCE.md` | Check support, uncertainty, and overclaiming. |
| Albert Conversation Reviewer | `roles/ROLE-CONVERSATION.md` | Check clarity, tone, audience fit, and revision priorities. |
