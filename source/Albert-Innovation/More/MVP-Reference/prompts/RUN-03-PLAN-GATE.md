...
Required inputs: complete W08-PLAN/draft KC10/planned T06, W05-GRAPH/VIEW, actual raw spans and owner scope; for graph-first review the plan fields may be explicitly not_started

Saved output suffixes: W06-PLAN (graph/view result and, when present, plan result)
...
Check exact source/claim/exhibit identities, every grant's actual unit/use, conflict endpoints and planned question premises. Confirm a complete reverse path to the raw wording; check every card clause, including negatives. A graph-first inspection may label plan NOT_STARTED; it does not clear an absent plan. Only a complete supported plan gets plan_checked_candidate. Return concrete minimal findings and which inputs were actually inspected. The human authorizes drafting after the complete plan check, not just after a graph check. Do not rewrite the plan or invent missing authority.

## Included P01

Source: [reference/process-0.3/imports/prompts/P01-evidence-check.md](../reference/process-0.3/imports/prompts/P01-evidence-check.md). Byte source SHA-256: `0397684e17a87940296d1412829d7d9f147233081355a4a77448815fe959c457`.
...
Source: [reference/process-0.3/P07-source-consumer-handoff.md](../reference/process-0.3/P07-source-consumer-handoff.md). Byte source SHA-256: `cd6a644ab7c0039dabe919d9acab415cab7a2c5b9ddfe1d9606f14c02f77e1c2`.
