...
The owner explicitly authorized copying useful DAD assets into this team digital asset package and an optional working read-only connection. This is the recorded scope of this delivery. We preserve the donor's notice and do not assert a general open-source license. Broader public redistribution needs an explicit package license and treatment of adapted material; no DAD private data or catalog rows are included here.
